    ...
    <div class="container">
      ...
      <div v-else>
        <div class="flex justify-between">
          <h1 class="text-black font-semibold text-2xl mb-5 capitalize">Upcoming Anime</h1>
        </div>
        ...
        <div v-if="ongoing.pagination" class="flex justify-center items-center text-black my-4 space-x-4">
          <button @click="page--" :disabled="page === 1" class="bg-deep_blue hover:bg-primary_light text-white font-semibold py-2 px-4 rounded transition duration-300 ease-in-out">Previous</button>
          ...
          <button
            ...
            class="bg-deep_blue hover:bg-primary_light text-white font-semibold py-2 px-4 rounded transition duration-300 ease-in-out"
          >
            Next
          </button>
        </div>
